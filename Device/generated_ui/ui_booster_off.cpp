...
void ui_init_booster_off() {
    ...
    ui_booster_off_dynamic_group_booster_off_text->start_y = 720;//260
    ...
    ui_booster_off_dynamic__group_spin_off_text->start_y = 770;//302
    ...
    ui_booster_off_dynamic__group_cap_charge_text->start_y = 820;//352
